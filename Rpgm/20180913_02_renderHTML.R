...
# load other sources
if(T){
  source("Rpgm/20180913_02_TreeModel_TuningParameter.R", encoding="utf-8")
}

knitr::opts_knit$set(root.dir = getwd())

# Rmarkdown(.Rmd) filename
inputFileNm_Rmd <- "Rpgm/20180913_02_sample.Rmd"

# output html filename
#outFilePath_html <- paste0(inputDir, "sample_", GetDateTime_YYYYMMDD_HHMMSS(), ".html")
outFilePath_html <- paste0(inputDir, "sample_", strTreeCondition, "_", GetDateTime_YYYYMMDD_HHMMSS(), ".html")
