# 20180918_02_renderHTML_whatsCook_xgboostModel.R
#
# @date  : 2018/09/18(Tue.)
...
# load other sources
source("Rpgm/20180918_02_xgboostModel_WhatsCook.R", encoding="utf-8")

knitr::opts_knit$set(root.dir = getwd())

# Rmarkdown(.Rmd) filename
inputFileNm_Rmd <- "Rpgm/20180918_02_xgboostModel_WhatsCook.Rmd"

# output html filename
#outFilePath_html <- paste0(inputDir, "sample_", GetDateTime_YYYYMMDD_HHMMSS(), ".html")
outFilePath_html <- paste0(inputDir, "XgboostModel_[", targetName, "]_", GetDateTime_YYYYMMDD_HHMMSS(), ".html")
