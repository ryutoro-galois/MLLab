# 20181009_fastrText_WhatsCook_Corr_renderHTML.R
#
# @date  : 2018/10/09(Tue.)
...
# load other sources
source("Rpgm/20181009_fastrText_WhatsCook_Corr.R", encoding="utf-8")

knitr::opts_knit$set(root.dir = getwd())

# Rmarkdown(.Rmd) filename
inputFileNm_Rmd <- "Rpgm/20181009_fastrText_WhatsCook_Corr.Rmd"

# output html filename
outFilePath_html <- paste0(inputDir, statisticalMethodNm, "_[", targetName, "]_", GetDateTime_YYYYMMDD_HHMMSS(), ".html")
