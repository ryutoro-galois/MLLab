...
if(T){
  ...
  datTrain[,"ingredients_str"] <- gsub(rex('|')," ", datTrain[,"ingredients_str"])
}
if(T){
  datTest[,"ingredients_str"] <- gsub(" ", "_", datTest[,"ingredients_str"])
  datTest[,"ingredients_str"] <- gsub(rex('|')," ", datTest[,"ingredients_str"])
}
