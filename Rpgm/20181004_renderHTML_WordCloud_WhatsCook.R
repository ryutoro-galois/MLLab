# 20181004_renderHTML_WordCloud_WhatsCook.R
#
# @date  : 2018/10/04(Thu.)
...
# load other sources
source("Rpgm/20181004_WordCloud_WhatsCook.R", encoding="utf-8")

knitr::opts_knit$set(root.dir = getwd())

# Rmarkdown(.Rmd) filename
inputFileNm_Rmd <- "Rpgm/20181004_sample.Rmd"

# output html filename
outFilePath_html <- paste0(inputDir, "WordCloud_WhatsCook_", GetDateTime_YYYYMMDD_HHMMSS(), ".html")
