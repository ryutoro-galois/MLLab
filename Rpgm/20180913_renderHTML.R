...
# load other sources
if(T){
  source("Rpgm/20180913_SummaryInfo.R", encoding="utf-8")
}

knitr::opts_knit$set(root.dir = getwd())

# Rmarkdown(.Rmd) filename
inputFileNm_Rmd <- "Rpgm/20180913_sample.Rmd"

# output html filename
if(initLoadFlg==T){
  outFilePath_html <- paste0(inputDir, "sample_", GetDateTime_YYYYMMDD_HHMMSS(), "_init.html")
} else {
